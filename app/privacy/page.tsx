...
export const metadata = pageMetadata({
  title: "プライバシーポリシー",
  description:
    "Each Spiritのプライバシーポリシー。アカウント情報・利用状況データの取得目的、Cookie・セッション、外部サービス（認証・ホスティング）の利用、第三者提供についてご説明します。",
  path: routes.privacy,
});
  ...
  return (
    ...
    >
      ...
      <ul className="mt-3 list-disc space-y-1.5 pl-6">
        ...
        <li><strong>アクセス情報</strong>: 将来的にアクセス解析を導入する場合、閲覧ページ・参照元・端末/ブラウザ情報等を取得することがあります。</li>
      </ul>
      ...
      <h2 className="mt-8 text-2xl font-semibold">10. 本ポリシーの改定</h2>
      <p className="mt-3">
