...
export const metadata = pageMetadata({
  title: "サイト内検索｜比較・ランキング・おすすめ記事を探す",
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto w-[min(1360px,calc(100%-40px))] py-6 max-sm:w-[min(1360px,calc(100%-24px))] sm:py-9 lg:py-12">
          ...
          <div className="mt-4 grid gap-5 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div>
              <h1 className="text-[1.75rem] font-bold leading-[1.15] tracking-normal text-slate-950 sm:text-4xl lg:text-5xl">記事・店舗・ランキングを横断検索</h1>
            ...
            <SearchForm className="rounded-lg border border-slate-200 bg-slate-50 p-3 shadow-sm max-sm:shadow-none" placeholder="例: 新潟 ラーメン 駐車場 / 食堂 / カフェ" />
          </div>
        </div>
      </section>
