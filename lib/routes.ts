...
export const routes = {
  ...
  sectionArticles: (majorCategory: string, section: string) => "/" + majorCategory + "/" + section + "/articles",
  sectionArticle: (majorCategory: string, section: string, slug: string) => "/" + majorCategory + "/" + section + "/articles/" + slug,
  ...
  foodRamenArticle: (slug: string) => "/food/ramen/articles/" + slug,
  ...
  foodCafeArticle: (slug: string) => "/food/cafe/articles/" + slug,
  ...
  ramenArticle: (slug: string) => "/food/ramen/articles/" + slug,
  ...
  beautyArticle: (_region: string, slug: string) => "/beauty/hair-salon/articles/" + slug,
  travel: "/travel",
  ...
  cafeArticle: (_region: string, slug: string) => "/food/cafe/articles/" + slug,
